...
from_datetimezone(_Conf) ->
    <<"20140519T100000.030Z">> = ncalendar_iso8601_ms:from_datetimezone({
        {{2014, 5, 19}, {10, 0, 0}}, {millisecond, 30}, <<"Z">>
    }),
    ...
    <<"20140601T080000.030+1100">> = ncalendar_iso8601_ms:from_datetimezone({
        {{2014, 5, 31}, {21, 0, 0}}, {millisecond, 30}, +1100
    }).
...
to_datetimezone(_Conf) ->
    {{{2014, 5, 19}, {10, 0, 0}}, {millisecond, 30}, +0000} = ncalendar_iso8601_ms:to_datetimezone(
        <<"20140519T100000.030Z">>
    ),
    {{{2014, 5, 19}, {7, 0, 0}}, {millisecond, 30}, +0300} = ncalendar_iso8601_ms:to_datetimezone(
        <<"20140519T100000.030+0300">>
    ),
    {{{2014, 5, 19}, {12, 30, 0}}, {millisecond, 30}, -0230} = ncalendar_iso8601_ms:to_datetimezone(
